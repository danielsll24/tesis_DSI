...
#seleccionar variables a considerar y zacbiar nombres
head(esc_loc_pob,1)
...
write.csv(dsi, file = "/Volumes/DANIEL/tesis_DSI/archivos/dsi_SQ_E1_zac.csv", row.names = FALSE)
write.csv(db, file="/Volumes/DANIEL/tesis_DSI/archivos/db_SQ_E1_zac.csv", row.names = F)
...
write.csv(db, file="/Volumes/DANIEL/tesis_DSI/archivos/db_SQ_E3_zac.csv", row.names = F)
write.csv(dsi, file = "/Volumes/DANIEL/tesis_DSI/archivos/dsi_SQ_E3_zac.csv", row.names = FALSE)
...
write.csv(db, file="/Volumes/DANIEL/tesis_DSI/archivos/db_E1_E3_zac.csv", row.names = F)
write.csv(dsi, file = "/Volumes/DANIEL/tesis_DSI/archivos/dsi_E1_E3_zac.csv", row.names = FALSE)
