...
head(esc_loc_pob,1)
db <- data.frame(esc_loc_pob$SECCION,esc_loc_pob$munn.x,esc_loc_pob$edo,esc_loc_pob$edon.x,
...
colnames(db)<- c("seccion","munn","edo","edon","disloc2016","disloc2013","pobtot","esc1","esc3","urbana","rural","mixta")
# seleccionar variables a considerar y zacbiar nombres
