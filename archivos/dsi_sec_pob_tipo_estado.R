...
d <- read.csv(paste(dd, "cpsLoc.csv", sep = ""), stringsAsFactors = FALSE)
head(d,1)
 
kk <- "/Volumes/DANIEL/comparaciones/"
k<-read.csv(paste(kk,"cps.csv",sep=""),stringsAsFactors = F)
head(k,1)    
...
#seleccionar variables a considerar y cpsbiar nombres
head(esc_loc_pob,1)
db <- data.frame(esc_loc_pob$SECCION,esc_loc_pob$munn.x,esc_loc_pob$edon.x,
                 esc_loc_pob$disloc2018.x, esc_loc_pob$disloc2012.x, esc_loc_pob$POBTOT, esc_loc_pob$escenario1,
...
write.csv(dsi, file = "/Volumes/DANIEL/tesis_DSI/archivos/dsi_SQ_E1_cps.csv", row.names = FALSE)
write.csv(db, file="/Volumes/DANIEL/tesis_DSI/archivos/db_SQ_E1_cps.csv", row.names = F)
...
write.csv(db, file="/Volumes/DANIEL/tesis_DSI/archivos/db_SQ_E3_cps.csv", row.names = F)
write.csv(dsi, file = "/Volumes/DANIEL/tesis_DSI/archivos/dsi_SQ_E3_cps.csv", row.names = FALSE)
...
write.csv(db, file="/Volumes/DANIEL/tesis_DSI/archivos/db_E1_E3_cps.csv", row.names = F)
write.csv(dsi, file = "/Volumes/DANIEL/tesis_DSI/archivos/dsi_E1_E3_cps.csv", row.names = FALSE)
